...
## b)
$$
y_1 =\Big(1 + \exp \Big( -\beta_{01} - \sum_{m=1}^{64} \beta_{m1} max \Big( \gamma_{0m}\sum_{l=1}^{64} \gamma_{lm} max \Big( \alpha_{0l}\sum_{j=1}^{17}\alpha_{jl}x_j,0 \Big),0\Big) \Big)^{-1}\Big)
$$
